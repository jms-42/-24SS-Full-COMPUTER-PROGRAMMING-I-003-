...
public class SafeInput {
    ...
    public static int getRangedInt(Scanner pipe, String prompt, int low, int high) {
        ...
        if (low == high) {
            System.out.println("You are about to delete the item number " + low + ".");
            deleteConfirmed = getYNConfirm(pipe, "Are you sure you want to delete this item? (Y/N): ");
            if (!deleteConfirmed) {            pipe.nextLine();
        ...
        do {
            ...
            if (value < low || value > high) {
                System.out.println("Error: Input out of range. Please enter a number between " + low + " and " + high + ".");
            }
